...
export function Login() {
  ...
  return (
    <>
      <div className="w-3/5 h-4/5 bg-[url('./images-icons/cartshop.png')] bg-contain bg-no-repeat drop-shadow-md flex justify-end  mx-auto mt-10 forms">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="flex justify-between h-36">
              <label className="text-stone-400 h-6">
                <input
                  className="w-4 h-4 p-1 border border-stone-300 bg-transparent appearance-none align-middle m-2  focus:outline-none transition focus:ring-[#D13429] focus:ring-1 focus:ring-offset-1 checked:bg-[#D13429] checked:bg-[url('./images-icons/check.png')] bg-[length:0.75em_0.75em] bg-no-repeat bg-center"
                  type="checkbox"
                  value="remember"
                  id="ck-remember"
                  name="ck-remember"
